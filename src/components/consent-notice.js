...
export default class ConsentNotice extends React.Component {
    ...
    render() {
        ...
        const declineButton = config.hideDeclineAll ? (
            ...
            <button
                className="cm-btn cm-btn-sm cm-btn-danger cm-btn-right cn-decline"
                type="button"
        ...
        const acceptAllButton = config.acceptAll ? (
            <button
        ...
        const acceptButton = (
            <button
                className="cm-btn cm-btn-sm cm-btn-accept cn-accept"
                type="button"
        ...
        return (
            ...
            >
                <div className="cn-body">
                    ...
                    <div className="cn-ok">
                        <a
                            className="cm-link cm-learn-more cn-learn-more"
                            href="#"
                            onClick={showModal}
                        >
